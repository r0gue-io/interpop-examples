...
export interface ChainEvents<Rv extends RpcVersion> extends GenericChainEvents<Rv> {
  ...
  multiTransactionPayment: {
     ...
     * [currency]
     **/
    CurrencyAdded: GenericPalletEvent<
      Rv,
      'MultiTransactionPayment',
      'CurrencyAdded',
      { assetId: number }
     ...
     * [currency]
     **/
    CurrencyRemoved: GenericPalletEvent<
      Rv,
      'MultiTransactionPayment',
      'CurrencyRemoved',
      { assetId: number }
  ...
  tips: {
    ...
    TipClosed: GenericPalletEvent<
      ...
      'Tips',
      'TipClosed',
      { tipHash: H256; who: AccountId32; payout: bigint }
    >
     ...
     **/
    TipSlashed: GenericPalletEvent<
      Rv,
      'Tips',
      'TipSlashed',
      { tipHash: H256; finder: AccountId32; deposit: bigint }
    >
  ...
  uniques: {
    ...
    ForceCreated: GenericPalletEvent<
      ...
      'Uniques',
      'ForceCreated',
      { collection: bigint; owner: AccountId32 }
    >
    ...
    Issued: GenericPalletEvent<
      ...
      'Uniques',
      'Issued',
      { collection: bigint; item: bigint; owner: AccountId32 }
    >
    ...
    OwnerChanged: GenericPalletEvent<
      ...
      'Uniques',
      'OwnerChanged',
      { collection: bigint; newOwner: AccountId32 }
    >
  ...
  claims: {
    Claim: GenericPalletEvent<
      ...
      'Claims',
      'Claim',
      [AccountId32, PalletClaimsEthereumAddress, bigint]
    >
  ...
  staking: {
     ...
     **/
    StakingInitialized: GenericPalletEvent<
      Rv,
      'Staking',
      'StakingInitialized',
  ...
  bonds: {
    ...
    Redeemed: GenericPalletEvent<
      ...
      'Bonds',
      'Redeemed',
      { who: AccountId32; bondId: number; amount: bigint }
    >
  ...
  lbp: {
     ...
     **/
    PoolUpdated: GenericPalletEvent<
      Rv,
      'LBP',
      'PoolUpdated',
      { pool: AccountId32; data: PalletLbpPool }
  ...
  referrals: {
     ...
     **/
    CodeRegistered: GenericPalletEvent<
      Rv,
      'Referrals',
      'CodeRegistered',
      { code: Bytes; account: AccountId32 }
    >
     ...
     **/
    LevelUp: GenericPalletEvent<
      Rv,
      'Referrals',
      'LevelUp',
      { who: AccountId32; level: PalletReferralsLevel }
    >
  ...
  tokens: {
     ...
     **/
    TotalIssuanceSet: GenericPalletEvent<
      Rv,
      'Tokens',
      'TotalIssuanceSet',
  ...
  vesting: {
     ...
     **/
    VestingSchedulesUpdated: GenericPalletEvent<
      Rv,
      'Vesting',
  ...
  evmAccounts: {
     ...
     **/
    ContractDisapproved: GenericPalletEvent<
      Rv,
      'EVMAccounts',
      'ContractDisapproved',
      { address: H160 }
  ...
  dca: {
     ...
     **/
    ExecutionStarted: GenericPalletEvent<
      Rv,
      'DCA',
      'ExecutionStarted',
     ...
     **/
    TradeFailed: GenericPalletEvent<
      Rv,
      'DCA',
      'TradeFailed',
      { id: number; who: AccountId32; error: DispatchError }
    >
  ...
  ormlXcm: {
    ...
    Sent: GenericPalletEvent<
      ...
      'OrmlXcm',
      'Sent',
      { to: StagingXcmV4Location; message: StagingXcmV4Xcm }
    >
