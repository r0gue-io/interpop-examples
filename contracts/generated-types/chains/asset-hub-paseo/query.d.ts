...
export interface ChainStorage<Rv extends RpcVersion> extends GenericChainStorage<Rv> {
  ...
  parachainSystem: {
    ...
    validationData: GenericStorageQuery<
      Rv,
      () => PolkadotPrimitivesV7PersistedValidationData | undefined
    >
    ...
    upgradeRestrictionSignal: GenericStorageQuery<
      Rv,
      () => PolkadotPrimitivesV7UpgradeRestriction | undefined
    >
    ...
    hostConfiguration: GenericStorageQuery<
      Rv,
      () => PolkadotPrimitivesV7AbridgedHostConfiguration | undefined
    >
  ...
  uniques: {
    ...
    class: GenericStorageQuery<
      Rv,
      (arg: number) => PalletUniquesCollectionDetails | undefined,
      number
    >
    ...
    asset: GenericStorageQuery<
      Rv,
      (arg: [number, number]) => PalletUniquesItemDetails | undefined,
      [number, number]
    >
    ...
    classMetadataOf: GenericStorageQuery<
      Rv,
      (arg: number) => PalletUniquesCollectionMetadata | undefined,
      number
    >
  ...
  nfts: {
    ...
    collection: GenericStorageQuery<
      Rv,
      (arg: number) => PalletNftsCollectionDetails | undefined,
      number
    >
    ...
    item: GenericStorageQuery<
      Rv,
      (arg: [number, number]) => PalletNftsItemDetails | undefined,
      [number, number]
    >
    ...
    collectionMetadataOf: GenericStorageQuery<
      Rv,
      (arg: number) => PalletNftsCollectionMetadata | undefined,
      number
    >
    ...
    itemAttributesApprovalsOf: GenericStorageQuery<
      Rv,
      (arg: [number, number]) => Array<AccountId32>,
      [number, number]
    >
    ...
    collectionConfigOf: GenericStorageQuery<
      Rv,
      (arg: number) => PalletNftsCollectionConfig | undefined,
      number
    >
