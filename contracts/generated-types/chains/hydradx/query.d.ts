...
export interface ChainStorage<Rv extends RpcVersion> extends GenericChainStorage<Rv> {
  ...
  multiTransactionPayment: {
     ...
     * @param {Callback<number | undefined> =} callback
     **/
    accountCurrencyMap: GenericStorageQuery<
      Rv,
     ...
     * @param {Callback<number | undefined> =} callback
     **/
    transactionCurrencyOverride: GenericStorageQuery<
      Rv,
      (arg: AccountId32Like) => number | undefined,
      AccountId32
    >
  ...
  uniques: {
    ...
    class: GenericStorageQuery<
      Rv,
      (arg: bigint) => PalletUniquesCollectionDetails | undefined,
      bigint
    >
    ...
    asset: GenericStorageQuery<
      Rv,
      (arg: [bigint, bigint]) => PalletUniquesItemDetails | undefined,
      [bigint, bigint]
    >
    ...
    classMetadataOf: GenericStorageQuery<
      Rv,
      (arg: bigint) => PalletUniquesCollectionMetadata | undefined,
      bigint
    >
  ...
  stateTrieMigration: {
    ...
    signedMigrationMaxLimits: GenericStorageQuery<
      Rv,
      () => PalletStateTrieMigrationMigrationLimits | undefined
    >
  ...
  referenda: {
    ...
    referendumInfoFor: GenericStorageQuery<
      Rv,
      (arg: number) => PalletReferendaReferendumInfo | undefined,
      number
    >
  ...
  assetRegistry: {
     ...
     **/
    assets: GenericStorageQuery<
      Rv,
      (arg: number) => PalletAssetRegistryAssetDetails | undefined,
      number
    >
     ...
     **/
    assetLocations: GenericStorageQuery<
      Rv,
      (arg: number) => HydradxRuntimeXcmAssetLocation | undefined,
      number
    >
  ...
  claims: {
    ...
    claims: GenericStorageQuery<
      Rv,
      (arg: PalletClaimsEthereumAddress) => bigint,
      PalletClaimsEthereumAddress
    >
  ...
  transactionPause: {
     ...
     * @param {Callback<[] | undefined> =} callback
     **/
    pausedTransactions: GenericStorageQuery<
      Rv,
      (arg: [BytesLike, BytesLike]) => [] | undefined,
      [Bytes, Bytes]
    >
  ...
  omnipoolWarehouseLM: {
     ...
     **/
    globalFarm: GenericStorageQuery<
      Rv,
      (arg: number) => PalletLiquidityMiningGlobalFarmData | undefined,
      number
    >
     ...
     **/
    deposit: GenericStorageQuery<
      Rv,
      (arg: bigint) => PalletLiquidityMiningDepositData | undefined,
      bigint
    >
  ...
  circuitBreaker: {
     ...
     **/
    liquidityAddLimitPerAsset: GenericStorageQuery<
      Rv,
      (arg: number) => [number, number] | undefined,
      number
    >
     ...
     * @param {Callback<[number, number] | undefined> =} callback
     **/
    liquidityRemoveLimitPerAsset: GenericStorageQuery<
      Rv,
      (arg: number) => [number, number] | undefined,
      number
    >
  ...
  dynamicFees: {
     ...
     **/
    assetFee: GenericStorageQuery<
      Rv,
      (arg: number) => PalletDynamicFeesFeeEntry | undefined,
      number
    >
  ...
  stableswap: {
     ...
     **/
    poolPegs: GenericStorageQuery<
      Rv,
      (arg: number) => PalletStableswapPoolPegInfo | undefined,
      number
    >
     ...
     **/
    assetTradability: GenericStorageQuery<
      Rv,
      (arg: [number, number]) => PalletStableswapTradability,
      [number, number]
    >
  ...
  bonds: {
     ...
     * @param {Callback<number | undefined> =} callback
     **/
    bondIds: GenericStorageQuery<
      Rv,
      (arg: [number, bigint]) => number | undefined,
      [number, bigint]
    >
  ...
  lbp: {
     ...
     **/
    poolData: GenericStorageQuery<
      Rv,
      (arg: AccountId32Like) => PalletLbpPool | undefined,
      AccountId32
    >
     ...
     * @param {Callback<boolean> =} callback
     **/
    feeCollectorWithAsset: GenericStorageQuery<
      Rv,
  ...
  xyk: {
     ...
     * @param {Callback<[number, number] | undefined> =} callback
     **/
    poolAssets: GenericStorageQuery<
      Rv,
  ...
  referrals: {
     ...
     * @param {Callback<Bytes | undefined> =} callback
     **/
    referralAccounts: GenericStorageQuery<
      Rv,
     ...
     * @param {Callback<AccountId32 | undefined> =} callback
     **/
    linkedAccounts: GenericStorageQuery<
      Rv,
  ...
  tokens: {
    ...
    accounts: GenericStorageQuery<
      Rv,
      (arg: [AccountId32Like, number]) => OrmlTokensAccountData,
      [AccountId32, number]
    >
  ...
  vesting: {
     ...
     **/
    vestingSchedules: GenericStorageQuery<
      Rv,
      (arg: AccountId32Like) => Array<OrmlVestingVestingSchedule>,
      AccountId32
    >
  ...
  xykWarehouseLM: {
    ...
    deposit: GenericStorageQuery<
      Rv,
      (arg: bigint) => PalletLiquidityMiningDepositData002 | undefined,
      bigint
    >
  ...
  emaOracle: {
     ...
     **/
    accumulator: GenericStorageQuery<
      Rv,
      () => Array<[[FixedBytes<8>, [number, number]], PalletEmaOracleOracleEntry]>
    >
