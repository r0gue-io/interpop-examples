...
export interface RuntimeApis<Rv extends RpcVersion> extends GenericRuntimeApis<Rv> {
  ...
  currenciesApi: {
    ...
    freeBalance: GenericRuntimeApiMethod<
      Rv,
      (assetId: number, who: AccountId32Like) => Promise<bigint>
    >
  ...
  evmAccountsApi: {
    ...
    boundAccountId: GenericRuntimeApiMethod<
      Rv,
      (evmAddress: H160) => Promise<AccountId32 | undefined>
    >
  ...
  locationToAccountApi: {
    ...
    convertLocation: GenericRuntimeApiMethod<
      ...
      ) => Promise<Result<AccountId32, XcmRuntimeApisConversionsError>>
    >
  ...
  chainlinkAdapterApi: {
    ...
    decodeOracleAddress: GenericRuntimeApiMethod<
      ...
      (
        oracleAddress: H160,
      ) => Promise<[number, number, HydradxTraitsOracleOraclePeriod, FixedBytes<8>] | undefined>
    >
  ...
  aaveTradeExecutor: {
    ...
    liquidityDepth: GenericRuntimeApiMethod<
      Rv,
      (assetIn: number, assetOut: number) => Promise<bigint | undefined>
    >
    ...
    pools: GenericRuntimeApiMethod<
      Rv,
      () => Promise<Array<HydradxRuntimeEvmAaveTradeExecutorPoolData>>
    >
