...
export interface VersionedHydradxApi<Rv extends RpcVersion> extends GenericSubstrateApi<Rv> {
 ...
 * @specVersion: 299
 **/
export interface HydradxApi {
  legacy: VersionedHydradxApi<RpcLegacy>
  v2: VersionedHydradxApi<RpcV2>
}
