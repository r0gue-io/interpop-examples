...
export type FrameSystemEventRecord = {
  phase: Phase
  event: AssetHubPaseoRuntimeRuntimeEvent
  topics: Array<H256>
}
...
export type PalletAssetsEvent =
  ...
  | {
      name: 'Transferred'
      data: { assetId: number; from: AccountId32; to: AccountId32; amount: bigint }
    }
  /**
  ...
  | {
      name: 'TeamChanged'
      data: { assetId: number; issuer: AccountId32; admin: AccountId32; freezer: AccountId32 }
    }
  /**
   * The owner changed.
   **/
  ...
  | {
      ...
      data: { assetId: number; accountsDestroyed: number; accountsRemaining: number }
    }
  /**
  ...
  | {
      ...
      data: { assetId: number; approvalsDestroyed: number; approvalsRemaining: number }
    }
  /**
  ...
  | {
      name: 'MetadataSet'
      data: { assetId: number; name: Bytes; symbol: Bytes; decimals: number; isFrozen: boolean }
    }
  /**
  ...
  | {
      ...
      data: { assetId: number; source: AccountId32; delegate: AccountId32; amount: bigint }
    }
  /**
...
export type PalletUniquesEvent =
  ...
  | {
      name: 'Transferred'
      data: { collection: number; item: number; from: AccountId32; to: AccountId32 }
    }
  /**
  ...
  | {
      name: 'TeamChanged'
      data: { collection: number; issuer: AccountId32; admin: AccountId32; freezer: AccountId32 }
    }
  /**
  ...
  | {
      name: 'ApprovedTransfer'
      data: { collection: number; item: number; owner: AccountId32; delegate: AccountId32 }
    }
  /**
  ...
  | {
      name: 'MetadataSet'
      data: { collection: number; item: number; data: Bytes; isFrozen: boolean }
    }
  /**
  ...
  | {
      name: 'AttributeSet'
      data: { collection: number; maybeItem?: number | undefined; key: Bytes; value: Bytes }
    }
  /**
  ...
  | {
      ...
      data: { collection: number; maybeItem?: number | undefined; key: Bytes }
    }
  /**
  ...
  | {
      ...
      data: { who: AccountId32; maybeCollection?: number | undefined }
    }
  /**
...
export type PalletNftsEvent =
  ...
  | {
      ...
      data: { collection: number; item: number; owner: AccountId32 }
    }
  /**
  ...
  | {
      ...
      data: { collection: number; item: number; delegate: AccountId32 }
    }
  /**
...
export type PalletAssetsEvent002 =
  ...
  | {
      name: 'Issued'
      data: { assetId: StagingXcmV3MultilocationMultiLocation; owner: AccountId32; amount: bigint }
    }
  /**
   * Some assets were transferred.
   **/
  ...
  | {
      name: 'Burned'
      data: { assetId: StagingXcmV3MultilocationMultiLocation; owner: AccountId32; balance: bigint }
    }
  /**
   * The management team changed.
   **/
  ...
  | {
      name: 'OwnerChanged'
      data: { assetId: StagingXcmV3MultilocationMultiLocation; owner: AccountId32 }
    }
  /**
   * Some account `who` was frozen.
   **/
  ...
  | {
      ...
      data: { assetId: StagingXcmV3MultilocationMultiLocation; newMinBalance: bigint }
    }
  /**
   * Some account `who` was created with a deposit from `depositor`.
   **/
  ...
  | {
      name: 'Deposited'
      data: { assetId: StagingXcmV3MultilocationMultiLocation; who: AccountId32; amount: bigint }
    }
  /**
   * Some assets were withdrawn from the account (e.g. for transaction fees).
   **/
...
export type CumulusPalletParachainSystemRelayStateSnapshotMessagingStateSnapshot = {
  ...
  ingressChannels: Array<
    [PolkadotParachainPrimitivesPrimitivesId, PolkadotPrimitivesV7AbridgedHrmpChannel]
  >
...
export type AssetHubPaseoRuntimeRuntimeHoldReason = null
...
export type PalletUtilityCall =
  ...
  | {
      name: 'WithWeight'
      params: { call: AssetHubPaseoRuntimeRuntimeCall; weight: SpWeightsWeightV2Weight }
    }
...
export type PalletProxyCall =
  ...
  | {
      name: 'AddProxy'
      params: { delegate: MultiAddress; proxyType: AssetHubPaseoRuntimeProxyType; delay: number }
    }
  /**
...
export type PalletAssetsCall =
  ...
  | {
      name: 'ForceCreate'
      params: { id: number; owner: MultiAddress; isSufficient: boolean; minBalance: bigint }
    }
  /**
  ...
  | {
      name: 'ForceTransfer'
      params: { id: number; source: MultiAddress; dest: MultiAddress; amount: bigint }
    }
  /**
  ...
  | {
      name: 'SetTeam'
      params: { id: number; issuer: MultiAddress; admin: MultiAddress; freezer: MultiAddress }
    }
  /**
  ...
  | {
      name: 'TransferApproved'
      params: { id: number; owner: MultiAddress; destination: MultiAddress; amount: bigint }
    }
  /**
...
export type PalletUniquesCall =
  ...
  | {
      name: 'ForceCreate'
      params: { collection: number; owner: MultiAddress; freeHolding: boolean }
    }
  /**
  ...
  | {
      name: 'Burn'
      params: { collection: number; item: number; checkOwner?: MultiAddress | undefined }
    }
  /**
  ...
  | {
      ...
      params: { collection: number; item: number; delegate: MultiAddress }
    }
  /**
  ...
  | {
      name: 'SetAttribute'
      params: { collection: number; maybeItem?: number | undefined; key: Bytes; value: Bytes }
    }
  /**
  ...
  | {
      name: 'ClearAttribute'
      params: { collection: number; maybeItem?: number | undefined; key: Bytes }
    }
  /**
  ...
  | {
      name: 'SetMetadata'
      params: { collection: number; item: number; data: Bytes; isFrozen: boolean }
    }
  /**
  ...
  | {
      ...
      params: { collection: number; data: Bytes; isFrozen: boolean }
    }
  /**
...
export type PalletAssetsCall002 =
  ...
  | {
      name: 'Burn'
      params: { id: StagingXcmV3MultilocationMultiLocation; who: MultiAddress; amount: bigint }
    }
  /**
   * Move some assets from the sender account to another.
   *
  ...
  | {
      ...
      params: { id: StagingXcmV3MultilocationMultiLocation; owner: MultiAddress }
    }
  /**
   * Change the Issuer, Admin and Freezer of an asset.
   *
  ...
  | {
      name: 'CancelApproval'
      params: { id: StagingXcmV3MultilocationMultiLocation; delegate: MultiAddress }
    }
  /**
   * Cancel all of some asset approved for delegated transfer by a third-party account.
   *
  ...
  | {
      name: 'TouchOther'
      params: { id: StagingXcmV3MultilocationMultiLocation; who: MultiAddress }
    }
  /**
   * Return the deposit (if any) of a target asset account. Useful if you are the depositor.
   *
