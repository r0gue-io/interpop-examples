...
export type FrameSystemEventRecord = {
  phase: Phase
  event: HydradxRuntimeRuntimeEvent
  topics: Array<H256>
}
...
export type PalletDemocracyEvent =
  ...
  | {
      name: 'Voted'
      data: { voter: AccountId32; refIndex: number; vote: PalletDemocracyVoteAccountVote }
    }
  /**
...
export type PalletCollectiveEvent =
  ...
  | {
      name: 'Proposed'
      data: { account: AccountId32; proposalIndex: number; proposalHash: H256; threshold: number }
    }
  /**
  ...
  | {
      name: 'Voted'
      data: { account: AccountId32; proposalHash: H256; voted: boolean; yes: number; no: number }
    }
  /**
...
export type PalletMultisigEvent =
  ...
  | {
      name: 'NewMultisig'
      data: { approving: AccountId32; multisig: AccountId32; callHash: FixedBytes<32> }
    }
  /**
...
export type PalletUniquesEvent =
  ...
  | {
      name: 'Transferred'
      data: { collection: bigint; item: bigint; from: AccountId32; to: AccountId32 }
    }
  /**
  ...
  | {
      name: 'TeamChanged'
      data: { collection: bigint; issuer: AccountId32; admin: AccountId32; freezer: AccountId32 }
    }
  /**
  ...
  | {
      ...
      data: { collection: bigint; item: bigint; owner: AccountId32; delegate: AccountId32 }
    }
  /**
  ...
  | {
      name: 'MetadataSet'
      data: { collection: bigint; item: bigint; data: Bytes; isFrozen: boolean }
    }
  /**
  ...
  | {
      name: 'AttributeSet'
      data: { collection: bigint; maybeItem?: bigint | undefined; key: Bytes; value: Bytes }
    }
  /**
  ...
  | {
      ...
      data: { collection: bigint; maybeItem?: bigint | undefined; key: Bytes }
    }
  /**
  ...
  | {
      ...
      data: { who: AccountId32; maybeCollection?: bigint | undefined }
    }
  /**
...
export type PalletStateTrieMigrationEvent =
  ...
  | {
      name: 'Migrated'
      data: { top: number; child: number; compute: PalletStateTrieMigrationMigrationCompute }
    }
  /**
...
export type PalletUtilityCall =
  ...
  | {
      name: 'DispatchAs'
      params: { asOrigin: HydradxRuntimeOriginCaller; call: HydradxRuntimeRuntimeCall }
    }
  /**
   * Send a batch of dispatch calls.
  ...
  | {
      name: 'WithWeight'
      params: { call: HydradxRuntimeRuntimeCall; weight: SpWeightsWeightV2Weight }
    }
...
export type StagingXcmV4Junction =
  ...
  | {
      type: 'AccountId32'
      value: { network?: StagingXcmV4JunctionNetworkId | undefined; id: FixedBytes<32> }
    }
  | {
      type: 'AccountIndex64'
      value: { network?: StagingXcmV4JunctionNetworkId | undefined; index: bigint }
    }
  | {
      type: 'AccountKey20'
      value: { network?: StagingXcmV4JunctionNetworkId | undefined; key: FixedBytes<20> }
    }
...
export type PalletIdentityCall =
  ...
  | {
      ...
      params: { authority: AccountId32; suffix: Bytes; allocation: number }
    }
  /**
...
export type PalletDemocracyCall =
  ...
  | {
      name: 'Delegate'
      params: { to: AccountId32; conviction: PalletDemocracyConviction; balance: bigint }
    }
  /**
...
export type PalletElectionsPhragmenCall =
  ...
  | {
      name: 'RemoveMember'
      params: { who: AccountId32; slashBond: boolean; rerunElection: boolean }
    }
  /**
...
export type PalletCollectiveCall =
  ...
  | {
      name: 'Propose'
      params: { threshold: number; proposal: HydradxRuntimeRuntimeCall; lengthBound: number }
    }
  /**
...
export type PalletProxyCall =
  ...
  | {
      name: 'AddProxy'
      params: { delegate: AccountId32; proxyType: HydradxRuntimeSystemProxyType; delay: number }
    }
  /**
...
export type PalletMultisigCall =
  ...
  | {
      ...
      params: { otherSignatories: Array<AccountId32>; call: HydradxRuntimeRuntimeCall }
    }
  /**
...
export type PalletUniquesCall =
  ...
  | {
      name: 'ForceCreate'
      params: { collection: bigint; owner: AccountId32; freeHolding: boolean }
    }
  /**
  ...
  | {
      name: 'Burn'
      params: { collection: bigint; item: bigint; checkOwner?: AccountId32 | undefined }
    }
  /**
  ...
  | {
      name: 'SetTeam'
      params: { collection: bigint; issuer: AccountId32; admin: AccountId32; freezer: AccountId32 }
    }
  /**
  ...
  | {
      name: 'SetAttribute'
      params: { collection: bigint; maybeItem?: bigint | undefined; key: Bytes; value: Bytes }
    }
  /**
  ...
  | {
      name: 'ClearAttribute'
      params: { collection: bigint; maybeItem?: bigint | undefined; key: Bytes }
    }
  /**
  ...
  | {
      name: 'SetMetadata'
      params: { collection: bigint; item: bigint; data: Bytes; isFrozen: boolean }
    }
  /**
  ...
  | {
      ...
      params: { collection: bigint; data: Bytes; isFrozen: boolean }
    }
  /**
...
export type XcmV3Junction =
  ...
  | {
      type: 'AccountId32'
      value: { network?: XcmV3JunctionNetworkId | undefined; id: FixedBytes<32> }
    }
  | {
      type: 'AccountIndex64'
  ...
  | {
      type: 'AccountKey20'
      value: { network?: XcmV3JunctionNetworkId | undefined; key: FixedBytes<20> }
    }
  | { type: 'PalletInstance'; value: number }
  | { type: 'GeneralIndex'; value: bigint }
  | { type: 'GeneralKey'; value: { length: number; data: FixedBytes<32> } }
...
export type PalletOmnipoolCall =
  ...
  | {
      ...
      params: { assetId: number; amount: bigint; recipient: AccountId32 }
    }
  /**
...
export type PalletLiquidityMiningLoyaltyCurve = {
...
export type HydradxTraitsRouterTrade = {
...
export type HydradxTraitsOracleOraclePeriod =
  | 'LastBlock'
  | 'Short'
  | 'TenMinutes'
  | 'Hour'
...
export type PalletReferralsFeeDistribution = {
  referrer: Permill
  trader: Permill
  external: Permill
}
...
export type OrmlTokensModuleCall =
  ...
  | {
      name: 'ForceTransfer'
      params: { source: AccountId32; dest: AccountId32; currencyId: number; amount: bigint }
    }
  /**
  ...
  | {
      name: 'SetBalance'
      params: { who: AccountId32; currencyId: number; newFree: bigint; newReserved: bigint }
    }
...
export type OrmlVestingVestingSchedule = {
  start: number
  period: number
  periodCount: number
  perPeriod: bigint
...
export type CumulusPrimitivesParachainInherentParachainInherentData = {
  ...
  horizontalMessages: Array<
    [PolkadotParachainPrimitivesPrimitivesId, Array<PolkadotCorePrimitivesInboundHrmpMessage>]
  >
}
...
export type XcmV2Instruction =
  ...
  | {
      type: 'QueryResponse'
      value: { queryId: bigint; response: XcmV2Response; maxWeight: bigint }
    }
  | {
      type: 'TransferAsset'
  ...
  | {
      type: 'Transact'
      value: { originType: XcmV2OriginKind; requireWeightAtMost: bigint; call: XcmDoubleEncoded }
    }
  | {
  ...
  | {
      type: 'ExchangeAsset'
      value: { give: XcmV2MultiassetMultiAssetFilter; receive: XcmV2MultiassetMultiAssets }
    }
  | {
  ...
  | {
      type: 'BuyExecution'
      value: { fees: XcmV2MultiassetMultiAsset; weightLimit: XcmV2WeightLimit }
    }
  | { type: 'RefundSurplus' }
  ...
  | {
      type: 'ClaimAsset'
      value: { assets: XcmV2MultiassetMultiAssets; ticket: XcmV2MultilocationMultiLocation }
    }
...
export type XcmV3Instruction =
  ...
  | {
      type: 'ReportHolding'
      value: { responseInfo: XcmV3QueryResponseInfo; assets: XcmV3MultiassetMultiAssetFilter }
    }
  | {
      type: 'BuyExecution'
  ...
  | {
      type: 'ExportMessage'
      value: { network: XcmV3JunctionNetworkId; destination: XcmV3Junctions; xcm: XcmV3Xcm }
    }
  | {
      type: 'LockAsset'
      value: { asset: XcmV3MultiassetMultiAsset; unlocker: StagingXcmV3MultilocationMultiLocation }
    }
  | {
      type: 'UnlockAsset'
      value: { asset: XcmV3MultiassetMultiAsset; target: StagingXcmV3MultilocationMultiLocation }
    }
  | {
      type: 'NoteUnlockable'
...
export type StagingXcmV4Instruction =
  ...
  | {
      type: 'TransferAsset'
      value: { assets: StagingXcmV4AssetAssets; beneficiary: StagingXcmV4Location }
    }
  | {
      type: 'TransferReserveAsset'
  ...
  | {
      type: 'DepositAsset'
      value: { assets: StagingXcmV4AssetAssetFilter; beneficiary: StagingXcmV4Location }
    }
  | {
      type: 'DepositReserveAsset'
      value: {
...
export type StagingXcmV4AssetWildAsset =
  ...
  | {
      type: 'AllOf'
      value: { id: StagingXcmV4AssetAssetId; fun: StagingXcmV4AssetWildFungibility }
    }
  | { type: 'AllCounted'; value: number }
  | {
      type: 'AllOfCounted'
 ...
 * The `Event` enum of this pallet
 **/
export type PalletClaimsEvent = {
  name: 'Claim'
  data: [AccountId32, PalletClaimsEthereumAddress, bigint]
}
...
export type PalletOmnipoolEvent =
  ...
  | {
      name: 'TokenAdded'
      data: { assetId: number; initialAmount: bigint; initialPrice: FixedU128 }
    }
  /**
  ...
  | {
      name: 'LiquidityAdded'
      data: { who: AccountId32; assetId: number; amount: bigint; positionId: bigint }
    }
  /**
...
export type PalletLiquidityMiningEvent =
  ...
  | {
      ...
      data: { globalFarmId: number; accumulatedRpz: FixedU128; totalSharesZ: bigint }
    }
  /**
...
export type PalletCircuitBreakerEvent =
  ...
  | {
      ...
      data: { assetId: number; tradeVolumeLimit: [number, number] }
    }
  /**
  ...
  | {
      ...
      data: { assetId: number; liquidityLimit?: [number, number] | undefined }
    }
  /**
...
export type PalletStableswapEvent =
  ...
  | {
      ...
      data: { poolId: number; assetId: number; state: PalletStableswapTradability }
    }
  /**
...
export type PalletBondsEvent =
  ...
  | {
      name: 'TokenCreated'
      data: { issuer: AccountId32; assetId: number; bondId: number; maturity: bigint }
    }
  /**
...
export type PalletXykEvent =
  ...
  | {
      name: 'LiquidityRemoved'
      data: { who: AccountId32; assetA: number; assetB: number; shares: bigint }
    }
  /**
   * Pool was created.
   **/
...
export type PalletReferralsEvent =
  ...
  | {
      name: 'CodeLinked'
      data: { account: AccountId32; code: Bytes; referralAccount: AccountId32 }
    }
  /**
  ...
  | {
      name: 'Converted'
      data: { from: PalletReferralsAssetAmount; to: PalletReferralsAssetAmount }
    }
  /**
   * Rewards claimed.
   **/
...
export type OrmlTokensModuleEvent =
  ...
  | {
      name: 'Transfer'
      data: { currencyId: number; from: AccountId32; to: AccountId32; amount: bigint }
    }
  /**
   * Some balance was reserved (moved from free to reserved).
   **/
  ...
  | {
      name: 'BalanceSet'
      data: { currencyId: number; who: AccountId32; free: bigint; reserved: bigint }
    }
  /**
  ...
  | {
      name: 'Slashed'
      data: { currencyId: number; who: AccountId32; freeAmount: bigint; reservedAmount: bigint }
    }
  /**
  ...
  | {
      name: 'LockSet'
      data: { lockId: FixedBytes<8>; currencyId: number; who: AccountId32; amount: bigint }
    }
  /**
...
export type PalletRelaychainInfoEvent =
   ...
   **/
  {
    ...
    data: { parachainBlockNumber: number; relaychainBlockNumber: number }
  }
...
export type PalletDcaEvent =
  ...
  | {
      name: 'TradeExecuted'
      data: { id: number; who: AccountId32; amountIn: bigint; amountOut: bigint }
    }
  /**
...
export type PalletXcmEvent =
  ...
  | {
      name: 'AssetsTrapped'
      data: { hash: H256; origin: StagingXcmV4Location; assets: XcmVersionedAssets }
    }
  /**
...
export type PalletBroadcastTradeOperation =
  | 'ExactIn'
  | 'ExactOut'
  | 'Limit'
  | 'LiquidityAdd'
...
export type PalletBroadcastFee = {
  asset: number
  amount: bigint
  destination: PalletBroadcastDestination
}

export type PalletBroadcastDestination =
...
export type PalletPreimageRequestStatus =
  | {
      type: 'Unrequested'
      value: { ticket: [AccountId32, FrameSupportTokensFungibleHoldConsideration]; len: number }
    }
  | {
      type: 'Requested'
      value: {
...
export type PalletOmnipoolPosition = {
  assetId: number
  amount: bigint
  shares: bigint
  price: [bigint, bigint]
...
export type PalletOmnipoolLiquidityMiningInconsistentStateError =
  | 'MissingLpPosition'
  | 'DepositDataNotFound'
...
export type PalletCircuitBreakerTradeVolumeLimit = {
  volumeIn: bigint
  volumeOut: bigint
  limit: bigint
}
...
export type PalletDynamicFeesFeeEntry = {
  assetFee: Permill
  protocolFee: Permill
  timestamp: number
}
...
export type CumulusPalletParachainSystemRelayStateSnapshotMessagingStateSnapshot = {
  ...
  ingressChannels: Array<
    [PolkadotParachainPrimitivesPrimitivesId, PolkadotPrimitivesV8AbridgedHrmpChannel]
  >
...
export type PalletCurrenciesRpcRuntimeApiAccountData = {
  free: bigint
  reserved: bigint
  frozen: bigint
}
